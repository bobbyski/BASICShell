...
public enum BASICKeywords {
    ...
    public static let pseudoClasses: Set<String> = [
        ...
        "TUIWINDOW", "TUIFLOATWINDOW", "TUISHELL", "TUITOOLBAR", "TUITABS", "TUIPANEL",
        ...
        "TUIRICH", "TUISPLIT", "TUISCROLL", "TUIDISCLOSURE", "TUIRIBBON",
        "TUIFLOW", "TUITOOLBOX", "TUISCROLLER", "TUIVIEWTHATFITS", "TUIPAGES",
        ...
        "TUIPREFS", "TUIFORM", "TUIPREFSDIALOG",
        "VECTORTERMINAL", "VTG",
    ]
