...
public struct SwiftAsyncShim {
    ...
    public func source() -> String? {
        guard !methods.isEmpty || !properties.isEmpty || !payloadProperties.isEmpty || !handlerProperties.isEmpty
              || !structProperties.isEmpty else { return nil }
        var lines = [
        ...
        for method in methods {
            ...
            if method.payloadResult != nil || method.structResult != nil { parameters.append("_ ti: Int") }
            let result: String
            if method.isInitializer || method.objectResult != nil || method.arrayResult != nil || method.stringResult
                || method.payloadResult != nil || method.structResult != nil {
