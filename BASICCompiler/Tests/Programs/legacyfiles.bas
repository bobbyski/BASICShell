...
print "WRITE HASH"
open "legacy-values.csv" for output as #3
write #3, "ADA, LOVELACE", 36, true, 'SHE SAID "HI"'
close #3

dim enabled as boolean
open "legacy-values.csv" for input as #3
input #3, fullName$, years, enabled, quote$
close #3
print fullName$
print years
print enabled
...
File.Rm "legacy-file-suite.txt"
File.Rm "legacy-values.csv"
